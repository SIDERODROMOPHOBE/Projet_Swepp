...
{
abi:[{"inputs":[{"internalType":"uint256","name":"_amount","type":"uint256"}],"name":"swapBAPtoSTC","outputs":[],"stateMutability":"nonpayable","type":"function"}]
} as const